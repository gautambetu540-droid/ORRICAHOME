(function(){
  ...
  mount.innerHTML=`<footer class="rich-footer">
    ...
    <div class="footer-main">
      <div class="footer-brand"><img src="assets/orrica-edge-logo.png" alt="Orrica Edge"><strong>People. Talent. Growth.</strong><p>Intelligent recruitment solutions that connect exceptional people with exceptional opportunities.</p><div class="socials">
  ...
  addLogin();setTimeout(addLogin,100);setTimeout(addLogin,500);
})();